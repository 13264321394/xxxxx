//
//  intodetailWebViewController.m
//  VECT
//
//  Created by 方墨 on 2018/5/14.
...
@interface intodetailWebViewController ()<UIWebViewDelegate>

@end

@implementation intodetailWebViewController
...
- (void)viewDidLoad {
    ...
    NSString *string1=@"https://etherscan.io/tx/";
    NSString *myString=[string1 stringByAppendingString:_str1];
