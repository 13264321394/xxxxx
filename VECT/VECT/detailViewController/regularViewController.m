...
@interface regularViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)getMoveDataSource
{
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.001 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSURL *url = [NSURL URLWithString:[portUrl stringByAppendingString:@"/appUser/periodDetails"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        cell.iconImageView.image=[UIImage imageNamed:@"VECTregular.png"];
        
        
        cell.label1.text=[self.dataSource[indexPath.row] objectForKey:@"projectName"];
        ...
        float floatstr=[[self.dataSource[indexPath.row] objectForKey:@"tProjectDetailInvestFund"] floatValue];
        ...
        /*
        cell.textLabel.text=[self.dataSource[indexPath.row] objectForKey:@"projectName"];
        ...
        */
        /*
         ...
         float floatstr=[[self.dataSource[indexPath.row] objectForKey:@"tProjectDetailInvestFund"] floatValue];
         NSString *str=[NSString stringWithFormat:@"+%f", floatstr];
         label.text = str;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    moreregdetailViewController *mdv=[[moreregdetailViewController alloc] init];
    mdv.str1=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"projectName"]];
    mdv.str2=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tProjectDetailInvestFund"]];
    mdv.str3=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tProjectDetailDayRate"]];
    mdv.str4=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"period"]];
    mdv.str5=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tProjectDetailRate"]];
    mdv.str6=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tProjectdetailtype"]];
    mdv.str7=[NSString stringWithFormat:@"%@", [[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tProjectDetailCreateDate"]];
...
/*
 ...
 {
 NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
 NSString *myuserId6=[userDefaults stringForKey:@"myuserId"];
 ...
 [parameters setValue:@"id" forKey:@"Sort"];
 [parameters setValue:@"desc" forKey:@"Order"];
 [parameters setValue:myuserId6 forKey:@"userId"];
 request.HTTPMethod = @"POST";
 [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
 NSString *args = [self convertToJsonData:parameters];
 request.HTTPBody = [args dataUsingEncoding:NSUTF8StringEncoding];
