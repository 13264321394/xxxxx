...
@interface returnsViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)getMoveDataSource
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.001 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSString *myuserId7=[userDefaults stringForKey:@"myuserId"];
        NSString *mytoken=[userDefaults stringForKey:@"mytoken"];
        
        NSURL *url = [NSURL URLWithString:[portUrl stringByAppendingString:@"/appUser/earningsDetails"]];
        ...
        [parameters setValue:myuserId7 forKey:@"userId"];
            ...
            if (error) {
                ...
                if (error) {
                    ...
                    if ([str00 isEqualToString:@"0"]) {
                        ...
                        NSMutableArray *mutarr=[dic2 objectForKey:@"data"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        cell.iconImageView.image=[UIImage imageNamed:@"VECTearnings.png"];
        
        cell.label1.text=[self.dataSource[indexPath.row] objectForKey:@"relationName"];
        ...
        float floatstr=[[self.dataSource[indexPath.row] objectForKey:@"tUserRelationNumber"] floatValue];
        ...
        /*
        cell.textLabel.text=[self.dataSource[indexPath.row] objectForKey:@"relationName"];
        float floatstr=[[self.dataSource[indexPath.row] objectForKey:@"tUserRelationNumber"] floatValue];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    morerutdetailViewController *mdv=[[morerutdetailViewController alloc] init];
    //属性传值
    mdv.str1=[[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"relationName"];
    mdv.str2=[[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tUserRelationNumber"];
    mdv.str3=[[self.dataSource objectAtIndex:indexPath.row] objectForKey:@"tUserRelationDate"];
