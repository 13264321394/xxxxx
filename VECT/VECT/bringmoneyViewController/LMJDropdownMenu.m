...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    [_mainBtn setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];
    [_mainBtn setTitle:@"请选择地址" forState:UIControlStateNormal];
    ...
    _mainBtn.titleLabel.font = [UIFont systemFontOfSize:5+GZDeviceWidth/35];
