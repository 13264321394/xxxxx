...
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"温馨提示" message:@"请前往手机桌面->[设置->隐私->定位服务->VECT]中打开VECT定位开关，就可以进行定位了" delegate:self cancelButtonTitle:@"知道了" otherButtonTitles:nil, nil];
    [alert show];
}
